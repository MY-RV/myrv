                ...
                <div className="flex gap-2 flex-wrap mt-3">
                    {
                        stack.map((item, index) => {
                            return <span className=" flex min-w-20 justify-center items-center rounded-full bg-[#7167ff15] px-3 py-1 text-xs font-medium leading-5 text-[#7167ff] " key={index}>{item}</span>
                        })
                    }
                </div>
            </div>
