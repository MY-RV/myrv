...
export const ProjectCard = ({ name, description, image, items, url }: Props) => {
    return (
        <div className="overflow-clip group flex flex-col justify-between gap-4 rounded w-full lg:px-4 lg:pt-4 border border-transparent custom-border-gradient lg:hover:shadow-sm lg:hover:bg-[#928ec40a] transition-colors duration-200 h-full">
            <div>
